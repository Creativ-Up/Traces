...
CREATE TABLE artworks (
    ...
    question_id             INTEGER, thumbnail_url TEXT, keywords_fr TEXT, keywords_nl TEXT, keywords_en TEXT, title TEXT, title_fr TEXT, title_nl TEXT, title_en TEXT, author TEXT,
